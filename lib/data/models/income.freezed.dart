...
mixin _$Income {
  ...
  @HiveField(3)
  String get source => throw _privateConstructorUsedError; // Salary, Freelance, Business, Investment, etc.
  @HiveField(4)
  ...
  @HiveField(8)
  String? get recurrenceFrequency => throw _privateConstructorUsedError; // monthly, weekly, yearly
  @HiveField(9)
