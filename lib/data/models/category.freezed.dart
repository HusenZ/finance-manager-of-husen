...
class _$CategoryImpl implements _Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, userId: $userId, name: $name, icon: $icon, color: $color, isCustom: $isCustom, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Category implements Category {
  const factory _Category({
    ...
    @HiveField(4) required final String color,
    @HiveField(5) final bool isCustom,
