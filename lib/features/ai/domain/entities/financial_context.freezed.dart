...
mixin _$FinancialContext {
  ...
  List<String> get topSpendingCategories => throw _privateConstructorUsedError;
  Map<String, double> get incomeSourceBreakdown =>
      throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $FinancialContextCopyWith<FinancialContext> get copyWith =>
      throw _privateConstructorUsedError;
}
...
/// @nodoc
class _$FinancialContextCopyWithImpl<$Res, $Val extends FinancialContext>
    implements $FinancialContextCopyWith<$Res> {
  _$FinancialContextCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? topSpendingCategories = null,
    Object? incomeSourceBreakdown = null,
...
class _$FinancialContextImpl extends _FinancialContext {
  ...
  final List<String> _topSpendingCategories;
  @override
  List<String> get topSpendingCategories {
    if (_topSpendingCategories is EqualUnmodifiableListView)
      return _topSpendingCategories;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_topSpendingCategories);
  }

  final Map<String, double> _incomeSourceBreakdown;
  @override
  Map<String, double> get incomeSourceBreakdown {
    if (_incomeSourceBreakdown is EqualUnmodifiableMapView)
      return _incomeSourceBreakdown;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_incomeSourceBreakdown);
  }
  ...
  @override
  String toString() {
    return 'FinancialContext(totalIncome: $totalIncome, totalExpenses: $totalExpenses, savings: $savings, savingsRate: $savingsRate, categoryBreakdown: $categoryBreakdown, topSpendingCategories: $topSpendingCategories, incomeSourceBreakdown: $incomeSourceBreakdown, transactionCount: $transactionCount, periodStart: $periodStart, periodEnd: $periodEnd)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FinancialContextImpl &&
...
abstract class _FinancialContext extends FinancialContext {
  ...
  factory _FinancialContext.fromJson(Map<String, dynamic> json) =
      _$FinancialContextImpl.fromJson;
