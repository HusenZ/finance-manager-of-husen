...
abstract class BudgetLoaded implements BudgetState {
  const factory BudgetLoaded({required final List<Budget> budgets}) =
      _$BudgetLoadedImpl;
...
class _$BudgetErrorImpl implements BudgetError {
  const _$BudgetErrorImpl({required this.message});
...
abstract class BudgetError implements BudgetState {
  const factory BudgetError({required final String message}) =
      _$BudgetErrorImpl;
...
/// @nodoc
class __$$BudgetSuccessImplCopyWithImpl<$Res>
...
class _$BudgetSuccessImpl implements BudgetSuccess {
  const _$BudgetSuccessImpl({required this.message});
  ...
  @override
  String toString() {
    return 'BudgetState.success(message: $message)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BudgetSuccessImplCopyWith<_$BudgetSuccessImpl> get copyWith =>
      __$$BudgetSuccessImplCopyWithImpl<_$BudgetSuccessImpl>(this, _$identity);
...
abstract class BudgetSuccess implements BudgetState {
  const factory BudgetSuccess({required final String message}) =
      _$BudgetSuccessImpl;
